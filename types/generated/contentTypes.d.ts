...
export interface ApiRestrauntTestRestrauntTest
  ...
  info: {
    description: '';
    displayName: 'restraunt-test';
    pluralName: 'restraunt-tests';
    singularName: 'restraunt-test';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dynamicTestComponent: Schema.Attribute.DynamicZone<
      ['shared.dynamic-zone-field']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::restraunt-test.restraunt-test'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    testComponent: Schema.Attribute.Component<'shared.test-component', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
